...
def generate_user_guide_pdf():
    ...
    output_path = "/Users/nimini/Projects/VPN Panel/docs/VPN-Panel-User-Guide-v2.0.0.pdf"
    ...
    story.append(Spacer(1, 10*mm))
    story.append(Paragraph("Version 2.0.0", styles['DocSubtitle']))
...
def generate_changelog_pdf():
    ...
    output_path = "/Users/nimini/Projects/VPN Panel/docs/VPN-Panel-Changelog-v2.0.0.pdf"
    styles = create_styles()
    ...
    story.append(HRFlowable(width="60%", thickness=2, color=HexColor('#3182ce')))
    story.append(Spacer(1, 10*mm))
    story.append(Paragraph("Version History: 1.0.0 - 2.0.0", styles['DocSubtitle']))
    story.append(Paragraph("April 2026", styles['DocSubtitle']))
    story.append(PageBreak())
